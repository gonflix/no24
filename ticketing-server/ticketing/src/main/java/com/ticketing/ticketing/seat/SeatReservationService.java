...
public class SeatReservationService {
    ...
    // 좌석예약: 분산락 + Redis Map Cache (TTL) 활용
    ...
    public Optional<SeatReservation> reserve(String userId, String seatId) {
        ...
        boolean aquired;
        try {
            aquired = lock.tryLock(0, 0, TimeUnit.SECONDS); // Non-blocking, 즉시 반환
        ...
        try {
            ...
            SeatReservation reservation = new SeatReservation(
                    ...
                    seatId,
                    Instant.now());
            map.putIfAbsent(seatId, reservation, RESERVATION_TTL, TimeUnit.MINUTES);
